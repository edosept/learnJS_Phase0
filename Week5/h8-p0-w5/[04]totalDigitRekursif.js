...
function totalDigitRekursif(angka) {
  ...
  } else { //mereturn angka to string dan menampilkan karakter ke-0, lalu karakter yang tampil dibatasi hanya 1 karakter
    return Number(angka.toString().substring(0, 1)) + totalDigitRekursif(Number(angka.toString().substring(1))); // dengan fungsi rekursif, menambahkan satu per satu angka dari digit paling depan ke paling belakang
  }
}
